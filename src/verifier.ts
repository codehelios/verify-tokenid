...
export interface tokenVerification { error: string, isValid: boolean, decoded: decodedToken}

export async function verifyTokenId(token: string, issuer: string, audience: string): Promise<tokenVerification> {
  let isValid = false;
  let error = null;
